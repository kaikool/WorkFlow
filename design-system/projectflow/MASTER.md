...
### System Logic & Role Permissions

1. **Quyền Hạn Của Admin (Quản Trị Hệ Thống):**
   - **Quyền tuyệt đối:** Admin có toàn quyền xem, sửa, xóa, phân công và thực hiện tất cả các tác vụ trong hệ thống, **bất kể Admin thuộc phòng ban nào** và không bị giới hạn bởi các ràng buộc phòng ban thông thường.
2. **Quyền Hạn Trình Tự Luồng Nghiệp Vụ:**
   - Tất cả các mô tả về luồng công việc (workflows), phê duyệt (approvals), hoặc kiểm duyệt được mô tả trong tài liệu **chỉ áp dụng từ cấp Ban Giám Đốc trở xuống** (Director -> Manager -> Staff). Quyền hạn của Admin luôn nằm ngoài và đứng trên toàn bộ các luồng này.
