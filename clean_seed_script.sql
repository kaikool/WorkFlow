...
-- 1. Xóa hàm trigger cũ nếu có để làm sạch
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- 2. Cập nhật hàm trigger tạo profile sang phiên bản an toàn để tránh lỗi trùng khóa (duplicate key) khi chèn dữ liệu
...
-- 3. Tạo lại trigger một cách chuẩn xác
...
BEGIN
  ...
  FROM unnest(ARRAY[
    'HUNGDN', 'NTB.HANH', 'QUYNHLN', 'DQTRUNG', 'NGAT.TT', 'HUONG.CT', 'TUPA', 'LT.HIEU', 'PHUONG.NTM', 'LANTTHI', 'NGOC.PQ', 'HOA.PQ', 'THUNTP', 'DAO.TH', 'QUYENPD', 'VAN.VUTHIHA', 'PHUCTD', 'NCCONG', 'CHANGMT', 'MAI.HN', 'ANHMT1', 'KHANH.PN', 'NHANNT16', 'DAONT4', 'CHINH', 'NGUYENVAN.HUNG', 'HUONG.NTK', 'DIEPHTH', 'NTT.GIANG', 'MYVTL', 'VANHH', 'SANGTT', 'NGUYENTHIVIET.ANH', 'DOTHI.HUYEN', 'TRANTHIHUE', 'TRANGNT13', 'HUYENDTT5', 'HONGDTM', 'THUYNB1', 'HANGNTT23', 'HUNGHM1', 'THULT5', 'DUYENNT5', 'LY.NTC', 'NGUYENDT2', 'LINHNTX', 'HUNGKM', 'HUYENLTM', 'PHUONGLT280', 'HUONGNTT136', 'TIENBQ', 'PHUONGNM9', 'HIENNV4', 'MENNTH', 'PH.THANG', 'HA.HN', 'DT.TUYEN', 'TRANGTTT20', 'PHUONGHB', 'LONG.LD', 'HUYDQ8', 'ANHMP', 'HUYENPTT2', 'THAODT3', 'NGAHQ', 'LOANTT2', 'PHUBD', 'CHINL', 'TAM.TONGTHI', 'NCSON', 'DANGHTH', 'TRUNG.HM', 'LY.LTK', 'LYNTM5', 'ANHTT13', 'HIEUNM3', 'LINHDLD', 'THANHPN4', 'MINHNQ6', 'THANGLC', 'QUYENDM', 'NTM.HOANG', 'NGUYENPX', 'MANHCD', 'ANHMQ', 'NGUYEN.THANHHUONG', 'NGUYENHUYENTRANG', 'HUONGHM', 'MAIPN', 'DUCVN', 'NGOCTTB1', 'DUNGNT54', 'TRANGNTT61', 'DATNT17', 'BUITHITHU.HA', 'HIEN.DOTHITHU', 'TRANG.NTH', 'LINHTD', 'THUY.PTB', 'HOANGTD', 'YEN.LTT', 'TOANND', 'DUCNH1', 'TRANGNT64', 'THANGBV', 'NGUYEN.THANHXUAN', 'VUPHUONGANH', 'HAIDT5', 'KHANH.NTN', 'HH.QUANG', 'DNLINH', 'ANNT4', 'LH.DUC', 'DUNG.DOTUAN', 'HUYEN.NGOTHITHU', 'CUONG.HM', 'THUVT2', 'NGANNT7', 'PHUONG.VTL', 'ANHNHP', 'TRANGNT50', 'ANHNM9', 'THANH.TRUONGTHI', 'NTTHU.THUY', 'NGOCTHU.NT', 'DUCCM', 'HOALT6', 'TRANGPTM1', 'HN.LINH', 'ANHNCT', 'CV.HOANG', 'ANHDD2', 'NGOCNB11', 'NGUYENBICHNGOC', 'CUONGDN', 'LANHDTT', 'ANHNT18', 'VANPT5', 'LAMNT12', 'TTM.ANH', 'BH.NGOC', 'HANGBVT', 'LTHAU'
  ]::text[]) AS x;
