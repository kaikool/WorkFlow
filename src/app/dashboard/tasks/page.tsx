  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6 md:space-y-8 animate-fade-in-up pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 md:gap-6 pt-4 sm:pt-0">
        ...
        <Button asChild className="bg-primary hover:bg-primary/90 text-primary-foreground h-10 px-5 rounded-xl font-medium active:scale-95 transition-all shadow-sm">
      ...
      <div className="flex items-center gap-2 bg-slate-50/60 p-1.5 rounded-2xl border border-slate-100/80 shadow-sm w-full h-13 sm:h-14">
        ...
        <div className="relative flex-1 group">
          ...
          <Input
            ...
            className="w-full pl-9 pr-3 h-10 text-xs font-semibold bg-white border-slate-200/60 rounded-xl focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary transition-all placeholder:text-[10px] sm:placeholder:text-xs"
            value={searchQuery}
        ...
        <Select value={filterStatus} onValueChange={setFilterStatus}>
          <SelectTrigger className="w-28 sm:w-44 h-10 bg-white border-slate-200/60 rounded-xl font-semibold text-slate-600 px-3 hover:border-primary/30 transition-all text-xs active:scale-95 justify-between shrink-0">
          ...
          <SelectContent className="rounded-xl border-none shadow-premium-hover p-1">
            <SelectItem value="all" className="rounded-lg py-2 text-xs font-bold">Tất cả</SelectItem>
            <SelectItem value="todo" className="rounded-lg py-2 text-xs font-bold">Đang chờ</SelectItem>
            {viewMode === 'task' && <SelectItem value="doing" className="rounded-lg py-2 text-xs font-bold">Đang làm</SelectItem>}
            <SelectItem value="done" className="rounded-lg py-2 text-xs font-bold">Hoàn thành</SelectItem>
            <SelectItem value="late" className="rounded-lg py-2 text-xs font-bold text-red-600">Trễ hạn</SelectItem>
          </SelectContent>
        </Select>
      </div>
