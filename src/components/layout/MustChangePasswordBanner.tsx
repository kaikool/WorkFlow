  ...
  return (
    <div className="page-container flex justify-center -mb-2 lg:-mb-4 relative z-10 pt-3 lg:pt-0">
      <Link
        ...
        className="inline-flex items-center gap-2 lg:gap-3 bg-amber-50 border border-amber-200 hover:bg-amber-100 transition-colors active:scale-[0.995] rounded-full px-4 py-2 shadow-sm max-w-full min-w-0"
      >
        <AlertTriangle className="h-4 w-4 text-amber-600 shrink-0" />
        <span className="text-[13px] font-semibold text-amber-800 truncate min-w-0">
