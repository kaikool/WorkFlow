...
>(({ className, children, "aria-describedby": ariaDescribedBy, ...props }, ref) => (
 ...
 className={cn(
 "fixed left-[50%] top-[50%] z-50 grid w-[calc(100dvw-32px)] max-w-lg translate-x-[-50%] translate-y-[-50%] touch-pan-y gap-5 overflow-x-hidden overscroll-contain rounded-2xl border border-slate-100 bg-background p-5 shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:w-[calc(100vw-32px)] sm:p-6",
 className
 )}
 {...props}
 >
