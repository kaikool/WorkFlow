...
**Phiên bản:** 1.2 — 2026-05-24 (sync mã nguồn: tasks đã refactor đủ 3 folder, team có 9 components không 12, team/[id] giờ là redirect stub, gỡ tham chiếu `TECHNICAL_RULES.md`).
